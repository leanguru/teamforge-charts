...
{"stages":[{"_$group":{"_id":"$importTimestamp","docs":{"_$push":{"datetime":{"_$var":"datetime_field"},"assignedTo":"$assignedTo","estimatedEffort":"$estimatedEffort","actualEffort":"$actualEffort","remainingEffort":"$remainingEffort"}}}},{"_$sort":{"_id":-1}},{"_$limit":1},{"_$unwind":"$docs"},{"_$project":{"datetime":"$docs.datetime","assignedTo":"$docs.assignedTo","estimatedEffort":"$docs.estimatedEffort","actualEffort":"$docs.actualEffort","remainingEffort":"$docs.remainingEffort"}},{"_$match":{"datetime":{"_$gte": {"_$var":"datetime_from"}, "_$lte": {"_$var":"datetime_until"}}}},{"_$group":{"_id":"$assignedTo","estimatedEffort":{"_$sum":"$estimatedEffort"},"actualEffort":{"_$sum":"$actualEffort"},"remainingEffort":{"_$sum":"$remainingEffort"}}},{"_$project":{"assignedTo":"$_id","estimatedEffort":"$estimatedEffort","actualEffort":"$actualEffort","remainingEffort":"$remainingEffort"}}], "type":"pipeline", "uri":"current_effort_per_user"}
